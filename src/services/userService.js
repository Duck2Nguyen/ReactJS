...
export {
    ...
    getExtraInforDoctorById, getProfileDoctorById, postPatientAppointment,
    postVerifyBookAppointment, createNewSpecialty, getAllSpecialty,
    getAllDetailSpecialtyById, createNewClinic, getAllDetailClinicById,
    getAllClinic, getAllPatientForDoctor, postSendRemedy
}