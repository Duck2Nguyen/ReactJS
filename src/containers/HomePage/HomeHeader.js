                ...
                <div className="home-header-container">
                    <div className="home-header-content">
                        <div className="left-content">
                            ...
                            <div className="header-log" onClick={() => this.returnToHome()}></div>
                        </div>
                        <div className="center-content">
                            <div className="child-content">
                                <div><b><FormattedMessage id="homeheader.speciality" /></b></div>
                                <div className="description"><FormattedMessage id="homeheader.searchdoctor" /></div>
                            </div>
                            <div className="child-content">
                            ...
                            <div className="child-content">
                                ...
                                <div className="description"><FormattedMessage id="homeheader.checkhealth" /></div>
                            </div>
                        </div>
